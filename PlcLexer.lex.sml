...
\\000"
 ...
 (1, 
"\005\005\005\005\005\005\005\005\005\036\038\005\005\005\005\005\
\\005\005\005\005\005\005\005\005\005\005\005\005\005\005\005\005\
\\036\034\005\005\005\005\032\005\030\029\027\026\025\023\005\022\
...
{fin = [(N 52),(N 70),(N 72)], trans = 0},
{fin = [(N 59),(N 70),(N 72)], trans = 0},
{fin = [(N 50),(N 70),(N 72)], trans = 0},
{fin = [(N 10),(N 70),(N 72)], trans = 9},
{fin = [(N 10)], trans = 9},
{fin = [(N 44),(N 70),(N 72)], trans = 0},
{fin = [(N 42),(N 70),(N 72)], trans = 0},
{fin = [(N 27),(N 70),(N 72)], trans = 13},
{fin = [(N 55)], trans = 0},
{fin = [(N 32),(N 70),(N 72)], trans = 15},
{fin = [(N 35)], trans = 0},
{fin = [(N 40),(N 70),(N 72)], trans = 0},
{fin = [(N 12),(N 70),(N 72)], trans = 18},
{fin = [(N 38)], trans = 0},
{fin = [(N 7),(N 70),(N 72)], trans = 20},
{fin = [(N 7)], trans = 20},
{fin = [(N 25),(N 70),(N 72)], trans = 0},
{fin = [(N 21),(N 70),(N 72)], trans = 23},
{fin = [(N 62)], trans = 0},
{fin = [(N 57),(N 70),(N 72)], trans = 0},
{fin = [(N 19),(N 70),(N 72)], trans = 0},
{fin = [(N 23),(N 70),(N 72)], trans = 27},
{fin = [(N 68)], trans = 0},
{fin = [(N 48),(N 70),(N 72)], trans = 0},
{fin = [(N 46),(N 70),(N 72)], trans = 30},
{fin = [(N 65)], trans = 0},
{fin = [(N 70),(N 72)], trans = 32},
{fin = [(N 17)], trans = 0},
{fin = [(N 14),(N 70),(N 72)], trans = 34},
{fin = [(N 30)], trans = 0},
{fin = [(N 4),(N 70),(N 72)], trans = 36},
{fin = [(N 4)], trans = 36},
{fin = [(N 1)], trans = 0}])
end
